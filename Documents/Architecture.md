````markdown
#  Midnight-Gate Architecture

## 1. Project Overview

 Midnight-Gate is a privacy-preserving credential and access-verification dApp built on the Midnight Network.
...
├── Documents/
│   ├── DEMO_CHECKLIST.md
│   ├── midnight_level3_ Midnight-Gate_plan.md
│   ├── PLAN.md
│   ├── PROPOSAL.md
│   └── TRUST_MODEL.md
│
...
└──────────────────────────────┬───────────────────────────────┘
                               ...
                               ▼
┌──────────────────────────────────────────────────────────────┐
│                     Midnight-Gate Compact Contract                   │
│                                                              │
...
ZK configuration loaded
        ↓
 Midnight-Gate contract joined or deployed
        ↓
...
# 7. Wallet Connection Architecture
 ...
 Midnight-Gate supports Midnight-compatible browser wallets through the dApp Connector API.
...
The core  Midnight-Gate circuit is:
...
During proof generation,  Midnight-Gate can represent stages such as:
...
This is the main Compact smart contract and the source of the  Midnight-Gate circuits.
...
# 20. End-to-End  Midnight-Gate Flow

```text
1. User opens  Midnight-Gate
        ↓
...
# 21. Architecture Summary
 ...
 Midnight-Gate uses a clear separation of responsibility:
